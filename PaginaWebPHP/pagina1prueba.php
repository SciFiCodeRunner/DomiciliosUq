...
<div class="w3-top">
  <ul class="w3-navbar w3-white w3-wide w3-padding-8 w3-card-2">
    <li>
      <a href="#home" class="w3-margin-left">Domicilios UQ</a>
    </li>
...
<div id="principal">
    <H1> hector y quezada hagan aqui un alista de establecimientos igual a la pagina de domicilios.com 
    </H1>
...
<header class="w3-display-container w3-content w3-wide" style="max-width:1600px" id="home">
  ...
  <div class="w3-display-bottomleft w3-padding-xlarge w3-opacity">
    <h1 class="w3-xxlarge">Lista de establecimientos</h1>
  </div>
</header>
